    ...
    return (
        <Layout>
            <section className="py-24 px-5 lg:px-10">
                <section className="relative z-0 bg-blue-300 p-8">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative text-center">
                        <h1
                            className="max-w-2xl mx-auto text-center font-manrope font-bold text-4xl mb-2 md:text-5xl md:leading-normal text-[tomato]">
                            #about
                        </h1>
                            ...
                            <div className="lg:pl-[100px] flex items-center">
                                <div className="data w-full">
                                    ...
                                    <p className="font-normal text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto">
                                        Driven by a passion for seamless user experiences, weve meticulously curated pagedone
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-9 ">
                            ...
                            <div className="lg:pr-24 flex items-center">
                                <div className="data w-full">
                                    ...
                                    <p className="font-normal text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto">
                                        Pagedone isnt just a collection of components and guidelines; its a philosophy. We go
                        ...
                        <div className="flex flex-col gap-5 xl:gap-8 lg:flex-row lg:justify-between">
                            <div
                                ...
                                <div className="flex gap-5">
                                    <div className="font-manrope text-2xl font-bold text-[tomato]">
                                        240%
                                    </div>
                                    <div className="flex-1">
                                        <h4 className="text-xl text-gray-900 font-semibold mb-2">Company growth</h4>
                                        <p className="text-xs text-gray-500 leading-5">Companys remarkable growth journey as we
                                    ...
                                    <div
                                        ...
                                        <div className="text-center lg:text-left lg:max-w-xs flex-1">
                                            <div className="mb-5 pb-5 border-b border-solid border-gray-300">
                                                ...
                                                <span className="text-sm text-[tomato]">Co-Founder &
                                                    CEO</span>
                                            </div>
                                            ...
                                            <div className="flex items-center gap-4 justify-center lg:justify-start">
                                                <p
                                                    className="cursor-pointer  text-gray-900 hover:text-white  hover: group w-12 h-12 rounded-full flex justify-center items-center bg-gray-100 transition-all duration-500 hover:bg-[tomato]">
                                                ...
                                                <p
                                                    className="cursor-pointer  text-gray-900 hover:text-white group w-12 h-12 rounded-full flex justify-center items-center bg-gray-100 transition-all duration-500 hover:bg-[tomato]">
                                    ...
                                    <div
                                        ...
                                        <div className="text-center lg:text-left lg:max-w-xs flex-1 flex flex-col justify-between">
                                            <div className="mb-5 pb-5 border-b border-solid border-gray-300">
                                                ...
                                                <span className="text-sm text-[tomato]">Lead Designer</span>
                                            </div>
                                            <p className="text-gray-500 leading-6 mb-7">
                ...
                <section className="py-20 ">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="bg-blue-300 rounded-2xl p-8 xl:p-11 text-black">
                            <h2 className="font-manrope text-4xl  text-center font-bold mb-4">Subscribe to the latest offer
                            </h2>
                            <p className="text-gray-600 text-center mb-11 max-lg:max-w-2xl mx-auto">Join our community of subscribers
                                and receive regular
                                updates delivered straight to your inbox. Its quick, easy, and free</p>

                            <div className="border shadow-md pl-2 border-black overflow-hidden max-w-md mx-auto bg-blue-300 flex justify-between items-center rounded-full">
                                <input type="email" name="email" className="bg-blue-300 py-2 border-0 outline-none px-5 placeholder:text-gray-600 rounded-full focus:bg-blue-300"
                                    placeholder="Enter your email.."
                                />
                                <button className="btn_2">Subscribe</button>
                            </div>
                        </div>
                    </div>
