...
const Cart = () => {
    ...
    return (
        <Layout>
            <section className="py-24  lg:px-10 px-5 min-h-[80vh]">
                {cartItems?.length > 0 ?
                    < div >
                            ...
                            <div className="lg:flex shadow-md my-10">
                                <div className="  w-full  sm:w-3/4 bg-white px-10 py-10">
                                    ...
                                    <div className="lg:flex md:flex sm:flex justify-between items-center gap-5">
                                        <button className=" hover:bg-gray-700 bg-black p-1 px- text-white mt-10">
                                        ...
                                        <button
                                            ...
                                            className=" bg-red-500 font-semibold hover:bg-red-600 p-1 px- text-white mt-10">
                                ...
                                <div className=" w-full   md:w-1/2     px-8 py-10">
                                    ...
                                    <div className="border-t mt-8">
                                        <div className="flex font-semibold justify-between py-6 text-sm uppercase">
                                            <span className="font-bold text-normal">Sub Total cost</span>
                                            <span className="font-bold text-normal text-xl"> ${totalPrice + shipping}</span>
                                        </div>

                                        <button
                                            onClick={checkoutHandler}
                                            className=" uppercase text-sm w-full hover:bg-gray-700 bg-black p-3 px-4 text-white mt-10">
                    ...
                    <div className="py-16 lg:max-w-[700px] flex flex-col gap-4 justify-center items-center">
                        <h1 className="font-bold text-2xl text-gray-600 mb-3">Your cart is Empty</h1>
                        <div>
