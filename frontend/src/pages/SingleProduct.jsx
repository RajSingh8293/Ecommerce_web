                ...
                <section className="text-gray-700 body-font overflow-hidden bg-white">
                    <div className="container px-5 py-24 mx-auto">
                        <div className="lg:w-[100%] mx-auto flex flex-wrap">
                            <div className="relative lg:w-[40%] w-[100%] border p-3 flex justify-center items-center">
                                <img
                                    alt="ecommerce"
                                ...
                                <div className="absolute top-2 left-2 flex flex-col gap-4">
                                    <div className="border p-3 rounded overflow-hidden">
                                        <img className="h-[100px]" src={product?.productImage} alt="" />
                                    </div>
                            ...
                            <div className="lg:w-[60%] w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                ...
                                <div className="flex w-[100%]">
                                    <button
                                        className="flex justify-center items-center w-[100%] text-white text-sm bg-black border-0 py-2 px-6 focus:outline-none font-medium hover:bg-gray-900"
                                ...
                                <div className="py-4">
                                    <button onClick={handleOpen} type="button" className="text-white bg-gray-800 hover:bg-black focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium  text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Add Your Review</button>
                                </div>
